...
\begin{resume}
	...
	\section{Personal\\Information\mysidestyle}%\vspace{2mm}
	Khaled M. El-Wazan \\
	...
	\section{Education\mysidestyle}\vspace{1mm}
	...
	\section{Current Affiliations\mysidestyle}\vspace{1mm}
	\begin{description}
	...
	\section{Job experiences\mysidestyle}\vspace{1mm}
	\begin{description}
	...
	\section{Extracurricular activities\mysidestyle}\vspace{1mm}
	\begin{description}
	...
	\section{Grants\mysidestyle}\vspace{1mm}
	\begin{description}
	...
	\section{Awards and Honors\mysidestyle}\vspace{1mm}
	\begin{description}
	...
	\section{Published papers\mysidestyle}
	...
	Khaled El-Wazan, Ahmed Younes and Salah B. Doma, `A Quantum Algorithm for Testing Junta Variables and Learning Boolean Functions via Entanglement Measure',  pp. 1--15, 2017. [Online]. Available: \href{http://arxiv.org/abs/1710.10495}{1710.10495}.



	\section{Conference Contributions\mysidestyle}

	Khaled El-Wazan, Mohamed Osman and Ahmed Younes, `A Transformation Framework for Cost Optimization in Circuit Design', \textit{2026 International Conference on Machine Intelligence and Smart Innovation (ICMISI)}.

	Khaled El-Wazan, Mohamed Osman and Ahmed Younes, `Greedy Algorithm for Optimizing NCT-Based Reversible Circuits Using Optimization Rules', \textit{2025 International Conference on Machine Intelligence and Smart Innovation (ICMISI)}. Available: \href{https://ieeexplore.ieee.org/document/11115702}{10.1109/ICMISI65108.2025.11115702}.
	...
	\section{Training Courses and Certificates\mysidestyle}
	\begin{itemize}
	...
	\section{Computer skills\mysidestyle}\vspace{1mm}
	\begin{description}
	...
	\section{Language skills\mysidestyle}\vspace{1mm}
