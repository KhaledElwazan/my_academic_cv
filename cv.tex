...
\begin{description}
\item[Operating systems] Advanced experience with most flavors of Linux, \textit{e.g.} Arch, Ubuntu, Mint and Debian. Experienced with Microsoft Windows and Mac OSX to some extent.
